      ...
      <div className="mx-auto flex max-w-7xl flex-col">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            {(!user || user.role === 'customer') && (
              <Link to="/cart" className="relative text-slate-500 dark:text-slate-300 transition-colors hover:text-blue-550 dark:hover:text-blue-455">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <Link
                  to="/login"
                  className="text-xs sm:text-sm font-medium text-slate-600 dark:text-slate-355 transition-colors hover:text-slate-900 dark:hover:text-white px-2 py-1.5 rounded-lg hover:bg-slate-100/50 dark:hover:bg-slate-805"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="rounded-lg bg-blue-600 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold text-white transition-all hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/20"
                >
                  Sign Up
                </Link>
              </div>
